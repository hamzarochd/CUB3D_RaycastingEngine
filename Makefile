...
CFLAGS = -Wall -Wextra -Werror -funroll-loops -O3 -ffast-math -mavx2 -flto
...
SRC = mandatory/get_next_line.c mandatory/get_next_line_utils.c mandatory/collisions.c \
		...
		mandatory/pixel_putters.c mandatory/raycasting_tools.c mandatory/tools.c mandatory/parsing_tools.c mandatory/gcollect.c
...
BSRC = bonus/get_next_line_bonus.c bonus/get_next_line_utils_bonus.c bonus/collisions_bonus.c \
		...
		bonus/parsing_tools_bonus.c bonus/gcollect_bonus.c
